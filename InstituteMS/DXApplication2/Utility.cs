...
namespace InstituteMS
{
    public class Utility
    {
        ...
        public static string OrgSecondName = string.Empty;
        ...
        public static string AppVersion = "3.9";
        ...
        public static void SendEmail(string Subject,string Body,string filepath,XtraForm Parent)
        {
            ...
            try
            {
                ...
                msg.From = new MailAddress("info@gyanasoft.com");
                ...
                smt.Host = "plesk1.s.fozzy.com";
                System.Net.NetworkCredential ntcd = new NetworkCredential();
                ntcd.UserName = "info@gyanasoft.com";
                ntcd.Password = "Iphone@2022";
        ...
        public static void PrintRecipt(int FeePaymentID,ref  string FilePath)
        {
            try
            {
                if (Utility.OrgShortName.ToLower() == "akshaya")
                {
                    FeeRecieptAkshaya rpt1 = new FeeRecieptAkshaya();
                    rpt1.Parameters["FeePaymentID"].Value = FeePaymentID;
                    rpt1.Parameters["OrgName"].Value = Utility.OrgName;
                    rpt1.Parameters["OrgAddress"].Value = Utility.OrgAddress;
                    rpt1.Parameters["OrgContact"].Value = Utility.OrgCNumber;
                    rpt1.Parameters["STNumber"].Value = Utility.STNumber;
                    rpt1.Parameters["OrgSecondName"].Value = Utility.OrgSecondName;
                    rpt1.Print();
                }
                else
                {
                    FeeReciept rpt = new FeeReciept();
                    ...
                    rpt.Parameters["OrgSecondName"].Value = Utility.OrgSecondName;
                    rpt.CreateDocument();
                    FilePath = Application.UserAppDataPath + "\\" + FeePaymentID + ".pdf";
        ...
        {
            return new DUser().GetAppVersion() == Utility.AppVersion;
        }
    }
}
