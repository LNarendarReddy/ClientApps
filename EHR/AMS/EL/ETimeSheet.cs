...
namespace EL
{
    public class ETimeSheet
    {
        ...
        public DataTable dtEmployeeTimings { get; set; }

        public DataTable dtEmployeeHours { get; set; }
        public DataTable dtNotifications { get; set; }
        ...
        public int Taskmins { get; set; }
        public object LiveHours { get; set; }
