...
namespace CMS
{
    ...
    {        
        ...
        {
            ResourceManager rm = new ResourceManager("CMS.Language.H", Assembly.GetExecutingAssembly());
    ...
    public class PrintersType
    {
        public static string NewSmallPrint = string.Empty;
        public static string NewBigPrint = string.Empty;
        public static string DuplicatePrint = string.Empty;
        public static string Samjawan = string.Empty;
        public static string JumboList = string.Empty;
