...
namespace IIT
{
    public partial class ucServices : ucLedgerTypeBase
    {
        ...
        {
            InitializeComponent();
            RegisterTextEdits(txtOpeningBalance, txtInterestClause);
        }
        private void ucServices_Load(object sender, EventArgs e)
        {
            ...
            cmbSign.EditValue = ledger.ServicesOrDuesToSubContractorsInfo.sign;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            ledger.ServicesOrDuesToSubContractorsInfo.sign = cmbSign.EditValue;
