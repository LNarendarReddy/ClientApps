...
namespace IIT.ReportForms
{
    public partial class ucTrailBalance : NavigationBase
    {
        ...
        private void FetchAndBindData()
        {
            ...
            lblDifference.Text = "Differences in Opening Balances : " +
                (Convert.ToDecimal(tlTrailBalance.GetSummaryValue(tlcDebitAmount))
                - Convert.ToDecimal(tlTrailBalance.GetSummaryValue(tlcCreditAmount))).ToString();
        }
    }
}
