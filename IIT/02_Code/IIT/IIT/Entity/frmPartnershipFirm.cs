...
namespace IIT
{
    public partial class frmPartnershipFirm : NavigationBase
    {
        ...
        {
            InitializeComponent();
            txtEmail.Validating += textEdit1_Validating;
            ...
            sttype = entityType == 12 ? "Partnership Firm" : entityType == 14 ? "AOP / BOI" : "Company";
            lblFormHeading.Text = "Creation of " + sttype;
        ...
        {
            if (!dxValidationProvider1.Validate() || !Utility.ValidatePan(txtPanNumber.EditValue, txtEntityName.EditValue) || !txtEmail.DoValidate())
                return;
        ...
        private void btnAddPartner_Click(object sender, EventArgs e)
        {
            ...
            frmAddPartner obj = new frmAddPartner(person, entityType == 13, gvPartners.RowCount + 1);
        ...
        private void btnEditPartner_Click(object sender, EventArgs e)
        {
            ...
            frmAddPartner obj = new frmAddPartner(personObj, entityType == 13, gvPartners.FocusedRowHandle + 1);
            Utility.ShowDialog(obj);
            if (personObj.IsSave)
            {
                gcPartners.RefreshDataSource();
        ...
        {
            lblFormHeading.Text = "Creation of " + sttype + " - " + txtEntityName.Text;
        }
    }
}