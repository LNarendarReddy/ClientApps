    ...
    public partial class frmEntityIndividual : NavigationBase
    {
        ...
        { 
            ...
            else
            {
                ...
                deDOB.EditValue = entityData.PersonData.First().DOB;
        ...
        {
            if (!dxValidationProvider1.Validate() || !Utility.ValidatePan(txtPanNumber.EditValue, txtPersonName.EditValue) || !txtEmail.DoValidate())
                return;
            ...
            entityData.PersonData.First().DOB = deDOB.EditValue;
