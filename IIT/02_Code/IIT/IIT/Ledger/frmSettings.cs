...
namespace IIT
{
    public partial class frmSettings : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmSettings_Load(object sender, EventArgs e)
        {
            ...
            cmbShowClosingBalance.EditValue = SelectedSettings.ShowClosingBalacne;
            lciShowClosingBalance.Visibility = 
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            {
                new LookUpRepository().SaveConfig(dtpFromDate.EditValue, 
                    dtpTodate.EditValue, cmbPurposeVisible.EditValue, cmbShowClosingBalance.EditValue);
