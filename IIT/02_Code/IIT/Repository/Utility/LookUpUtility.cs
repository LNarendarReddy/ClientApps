...
namespace Repository
{
    public static class LookUpUtility
    {
        ...
        private static DataTable dtTenureOfInvestment = null;
        ...
        public static DataTable GetTenureOfInvestment()
        {
            return dtTenureOfInvestment =
                dtTenureOfInvestment ?? lookUpRepository.GetLookUpData("Investment Tenure");
        }
    }
}
