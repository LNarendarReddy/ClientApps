        ...
        public override Ledger Save(Ledger ledgerObj)
        {
            try
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    decimal.TryParse(Convert.ToString(ledgerObj.LedgerTypeInfo.OpeningBalance), out decimal ob);
                    cmd.Parameters.AddWithValue("@OpeningBalance", ledgerObj.LedgerTypeInfo.sign.Equals("Cr") ? -ob : ob);
